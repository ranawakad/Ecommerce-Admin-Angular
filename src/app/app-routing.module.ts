...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'orders',
        loadChildren: () => import('./components/orders & order-items/order.module').then(m => m.OrderModule)
      },
      {
        path: 'payments',
        loadChildren: () => import('./components/payments/payment.module').then(m => m.PaymentModule)
      },
      {
        path: 'sellers',
